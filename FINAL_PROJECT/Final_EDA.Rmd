...
Please notice Eleum and Faraam are identical despite their body camera laws.
```{r}
...
Eleum <- data.frame(bclaw = c(0), marg2020=c(10), regions=c('NW'), le_per_100k= c(440), spendpc=c(645))
Faraam <- data.frame(bclaw = c(1), marg2020=c(10), regions=c('NW'), le_per_100k= c(440), spendpc=c(645))
```
