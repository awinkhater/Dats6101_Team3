...
```
We have created two subdata sets by grouping our data by state and by reigion (for graphical purposes). Here is the structure of both:
...
### SMART Question (DO NOT MESS WITH)
```{r}
