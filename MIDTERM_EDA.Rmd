...
First we call our packages: dplyr and ggplot2. Then we read the data set that comes from a csv file called FPS22.csv.
...
Then we remove the null values from our data set.
...
After accounting for null values, the data set we are working with has 6,574 observations. Below we have provided a sample row of the data.
...
The data set's structure is as follows:
...
Means and median for numeric variables (using age of the victim):
